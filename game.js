...
function checkAchievements() {
    ...
    const gameState = {
        ...
        guessHistory: guessedWords.map((guessWord, rowIndex) => {
            const colors = calculateTileColors(guessWord, word);
            return guessWord.map((letter, index) => ({
                letter,
    ...
    // Let achievements.js handle all achievements consistently
